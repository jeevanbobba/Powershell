...
############### Email Configuration ##################################
    ...
    $from = "COE-DevADhealth@DEV.dol.gov"#"bobba.jeevan@stage.dol.gov" # "Bobba.Jeevan@DOL.gov" 
    $To = "bobba.jeevan@dol.gov"
    $Bcc = "Bobba.Jeevan@DOL.gov","Behzad.Ellie@dol.gov","Surapaneni.Venu@dol.gov","Quintanilla.Raul.H@DOL.gov","Onadeko.Eddie@dol.gov","Manikya.Sandan@dol.gov","Katneni.Krishna.C@dol.gov","WatsonIII.George.A@DOL.GOV","Kleinkauf.Karl.H@dol.gov"
    $port = 25
    $priority = "Normal"
#...................................
# Functions
