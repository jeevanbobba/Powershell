...
$reportpath = "D:\JB\ADHealthCheck\ADReport.htm" 

if((test-path $reportpath) -like $false)
{
new-item $reportpath -type file
}
$smtphost = "smtp.dev.dol.gov" #"smtp.dev-ent.DEV-DIR.LABOR.GOV" 
$from = "DoNotReply@dev.dol.gov" 
$email1 = "jeevan.bobba@dol.gov"
$timeout = "60"
...
$subject = "DEV Domain Active Directory Health Monitor" 
$body = Get-Content "D:\JB\ADHealthCheck\ADReport.htm" -raw #"c:\temp\ADreport.htm" -raw
