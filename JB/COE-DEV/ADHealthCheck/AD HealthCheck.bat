...
$reportpath = "c:\temp\ADReport.htm" 

if((test-path $reportpath) -like $false)
{
new-item $reportpath -type file
}
$smtphost = "smtp.stage.dol.gov" 
$from = "DoNotReply@dol.gov" 
$email1 = "manikya.sandan@dol.gov"
$timeout = "60"
...
$subject = "STAGE Domain Active Directory Health Monitor" 
$body = Get-Content "c:\temp\ADreport.htm" 
